...
const projects = [
  {
    ...
    src: 'rock.jpg',
    link: 'https://videos.pexels.com/video-files/19806870/19806870-uhd_2560_1440_25fps.mp4',
    color: '#5196fd',
  },
  {
      ...
      <>
          ...
          >
            <h1 className='2xl:text-7xl text-4xl md:text-5xl px-8 font-semibold  text-center tracking-tight leading-[120%]'>
              Karakteristik Warga Masyarakat Indonesia <span className='block'>👇</span> 
            </h1>
            </ScrollElement>
          </section>
        </>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative md:flex py-3 md:py-0 text-center md:text-start md z-10 px-0 rounded-2xl    h-full mx-auto">
          <>
   
<div className='h-full [mask-image:_linear-gradient(to_right,transparent_0,_black_228px,_black_calc(100%-200px),transparent_100%)]  mb-5 md:mb-0 overflow-hidden w-full md:order-2   '>
        ...
        >
         ...
         <div className=' md:w-[40em] lg:w-[80em] flex md:p-14 content-center flex-col '>
          <div className='md:space-y-2 mb-3'>
            ...
            <p className="cursor-pointer  text-base pt-2 line-clamp-3  text-gray-400 capitalize">
            {description}
            </p>

          </div>
            <button
        className="relative m-auto md:m-0 md:mt-auto w-fit bg-gradient-to-b  hover:text-white from-[#edeffd] to-[#7b9cda] bg-clip-text text-transparent   flex items-center group after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-full after:origin-bottom-right after:scale-x-0 dark:after:bg-white 
