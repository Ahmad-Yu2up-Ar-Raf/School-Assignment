        ...
        <AnimatePresence initial={false} mode="sync">
          {isMediaModalOpen && (
            <>
              ...
              >
                <motion.div
                  className="pointer-events-auto relative flex flex-col overflow-hidden  bg-gray-950  w-[80%] h-[90%] "
                  layoutId={`dialog-${uniqueId}`}
                  tabIndex={-1}
                  style={{
                    borderRadius: '24px',
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute right-6 top-6 p-3 text-zinc-50 cursor-pointer bg-gray-900 rounded-full hover:bg-gray-800"
                    type="button"
